...
knitr::include_graphics("../man/figures/landmarking_models.PNG")
```
...
knitr::include_graphics("../man/figures/landmarking_lme_model.PNG")
```
...
knitr::include_graphics("../man/figures/fit_LOCF_landmark_model.PNG")
```
