...
knitr::include_graphics("./images/landmarking_models")
```
...
knitr::include_graphics("./images/landmarking_lme_model")
```
...
knitr::include_graphics("./images/fit_LOCF_landmark_model")
```
...
Fitting the survival model is performed using `fit_survival_model`. There are
