...
Below is an example of how to use this package with the pbc2 dataset. For more detailed examples and for an explanation of Landmark models, see https://isobelbarrott.github.io/Landmarking.
